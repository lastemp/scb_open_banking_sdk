...
use crate::{
    models::notifications_and_subscriptions::subscriptions::subscriptions::NotificationSubscriptionRetrieveAllResponseData,
    ...
    match res {
        ...
        Ok(response) => match response.status() {
            StatusCode::OK => {
                // 200
                match response
                    .json::<NotificationSubscriptionRetrieveAllResponseData>()
                    .await
                {
